...
contract TokenStaking {
    ...
    constructor(address _mainTokenAddress) {
        _mainToken = IERC20(_mainTokenAddress);
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        _mainToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        _mainToken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                _mainToken.transfer(recipient, balance);
            }
        }
    }
